...
namespace National_Admission_Agency.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> LoginHome(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                return RedirectToAction("DifferentPage", new { UserName = model.Email, Controller = "Admin" });
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                   ...
                   //return RedirectToAction("GetRolesforUser", new { UserName = model.Email, Controller = "Admin" });
                case SignInStatus.LockedOut:
                    return View("Lockout");
                case SignInStatus.RequiresVerification:
                    return RedirectToAction("SendCode", new { ReturnUrl = returnUrl, RememberMe = model.RememberMe });
